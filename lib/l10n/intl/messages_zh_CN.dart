...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "alwaysOnVpn": MessageLookupByLibrary.simpleMessage("始终开启的 VPN"),
    "alwaysOnVpnDesc": MessageLookupByLibrary.simpleMessage(
      "在 Android 系统设置中配置。FlClash 被终止后会自动重连；除非需要断网保护，否则不要开启“无 VPN 时阻止连接”。",
    ),
    ...
    "closeConnections": MessageLookupByLibrary.simpleMessage("关闭所有连接"),
